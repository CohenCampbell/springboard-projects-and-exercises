...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-12-06T01:23:42.937370" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgpool-ii-445-438-4215-4118-and-4025-released-2757/">Pgpool-II 4.4.5, 4.3.8, 4.2.15, 4.1.18 and 4.0.25 released.</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-11-30 by Pgpool Global Development Group</li>
              </ul>
            </li>
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6f7"> PGSQL Phriday #014: Wrapping up!</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Pavlo Golub</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-12-05</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6f8"> Announcing Crunchy Postgres for Kubernetes 5.5</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6f6"> PostgreSQL and FIPS mode</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6f5"> Advent of Code in PostgreSQL: Tips and Tricks from 2022</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Greg Sabino Mullane</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-12-04</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6f4"> PGSQL Phriday #014 — PostgreSQL Events</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andrew Atkinson</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-12-03</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6f2"> PGSQL Phriday #014: Postgres Events!</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Henrietta Dombrovskaya</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-12-02</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6f0"> Review: PostgreSQL at PASS Data Community Summit 2023</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Ryan Booz</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-12-01</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6e_"> My Illustrated Guide to Postgres at PASS Data Summit 2023</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6e-"> Some thoughts on Postgres events</a></h3>
            <ul class="meta">
